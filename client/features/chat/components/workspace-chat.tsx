...
import { workspaceRoutes } from "@/features/workspace/lib/routes";
              ...
              {conversationsLoading || messagesLoading ? (
                ...
                <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
                  ...
                  <div className="space-y-1">
                    <p className="font-medium">Chat with your sources</p>
                    <p className="max-w-sm text-sm text-muted-foreground">
                      Ask questions about the materials in this workspace.
                      Answers include citations when relevant context is found.
                    </p>
                  </div>
                </div>
              ) : (
