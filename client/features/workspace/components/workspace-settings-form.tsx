...
import { useDeleteWorkspace, useUpdateWorkspace } from "../hooks/use-workspace";
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 p-6">
      ...
      <div className="rounded-xl border border-destructive/30 p-4">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Deleting this workspace removes all sources, conversations, and
          indexed vectors permanently.
        </p>
        <Button
          type="button"
          variant="destructive"
