...
export const importYoutubeSchema = z.object({
  url: z.string().trim().url("Youtube URL is required"),
  title: z.string().trim().max(200).optional(),
});
...
export type ListSourcesQuery = z.infer<typeof listSourceQuerySchema>;
...
export type ReprocessSourcesSchema = z.infer<typeof reprocessSourcesSchema>;
