...
import { findSourcesByWorkspaceId } from "../repository/source.ropository";
import type { ArtifactRecord } from "../repository/artifact.repository";
...
export async function generateArtifactContent(
  ...
  const system = [
    `You are Talkbook, an expert learning assistant generating a ${type.toLowerCase()} from workspace source materials.`,
